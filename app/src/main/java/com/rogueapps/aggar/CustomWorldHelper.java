...
public class CustomWorldHelper {
	...
	public static World generateObjects(Context context) {
		...
		sharedWorld.setDefaultImage(R.drawable.beyondar_default_unknow_iconori);
...
//		 Create an object with an image in the app resources.
		...
		go1.setGeoPosition(sharedWorld.getLatitude()+0.0001d,sharedWorld.getLongitude()+0.0001d);
		go1.setImageResource(R.drawable.doherty);
